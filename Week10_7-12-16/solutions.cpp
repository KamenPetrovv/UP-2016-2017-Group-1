...
void getFibboNums (long n, long arr[]) { ///fill the arr[] array with the first n fibonacci numbers
    arr[0] = 1;
    arr[1] = 1;
...
int main() {
    ...
    ///insert some code here to initilize whatever variables are needed and test the functions we wrote^
